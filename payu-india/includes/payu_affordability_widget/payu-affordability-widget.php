...
if ($enable_affordability_widget) {
    function custom_scripts() {
        ...
        // Ensure global variables exist before use
        ...
        // Determine the amount and SKU details
        if (is_product() && $enable_widget_product && isset($product)) {
        ...
        wp_localize_script('custom-payu-widget', 'payuData', array(
            'amount'      => $amount,
            'key'         => $payu_key,
            'productinfo' => (is_product() && isset($product)) ? wp_strip_all_tags($product->get_name()) : 'WooCommerce Order',
